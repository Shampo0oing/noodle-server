        ...
        try {
            ...
            this.tasks = $(".event").map((i, el) => {
                return {
                    ...
                    deadline: $($(".description .row:nth-of-type(1) a:nth-of-type(1)").get(i)).text(),
                    course: $($(".description .mt-1:nth-of-type(4) .col-11 a").get(i)).text()===''?
                        $($(".description .mt-1:nth-of-type(1) .col-11 a").get(i)).text()
                        :$($(".description .mt-1:nth-of-type(4) .col-11 a").get(i)).text()
                };
            }).toArray();
